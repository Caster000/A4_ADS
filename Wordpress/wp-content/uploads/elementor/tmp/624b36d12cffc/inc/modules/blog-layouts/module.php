...
if ( ! class_exists( 'Interium_Blog_Layouts_Module' ) ) {

	/**
	 * Define Interium_Blog_Layouts_Module class
	 */
	class Interium_Blog_Layouts_Module extends Interium_Module_Base {
		/**
		 * properties.
		 */
		private $layout_type;
		...
		public function filters() {
			...
			add_filter( 'interium-theme/customizer/options', array( $this, 'customizer_options' ) );
			add_filter( 'interium-theme/customizer/blog-sidebar-enabled', array( $this, 'customizer_blog_sidebar_enabled' ) );
			add_filter( 'interium-theme/posts/template-part-slug', array( $this, 'apply_layout_template' ) );
			add_filter( 'interium-theme/posts/post-style', array( $this, 'apply_style_template' ) );
			add_filter( 'interium-theme/posts/list-class', array( $this, 'add_list_class' ) );
			add_filter( 'interium-theme/site-content/container-enabled', array( $this, 'disable_site_content_container' ) );
		...
		public function module_init_properties() {
			...
			$this->layout_type  = interium_theme()->customizer->get_value( 'blog_layout_type' );
			$this->layout_style = interium_theme()->customizer->get_value( 'blog_style' );
		...
		public function customizer_options( $options ) {
			...
			$new_options = array(
				'blog_layout_type' => array(
					...
					'field'    => 'select',
					'choices'  => array(
						'default'          => esc_html__( 'Listing', 'interium' ),
						'grid'             => esc_html__( 'Grid', 'interium' ),
						'masonry'          => esc_html__( 'Masonry', 'interium' ),
						'vertical-justify' => esc_html__( 'Vertical Justify', 'interium' ),
						'creative'         => esc_html__( 'Creative', 'interium' ),
					),
					'type' => 'control',
				),
				'blog_style' => array(
					'title'    => esc_html__( 'Style', 'interium' ),
					'section'  => 'blog',
					'priority' => 2,
					'default'  => 'default',
					'field'    => 'select',
					'choices'  => array(
						'default' => esc_html__( 'Style 1', 'interium' ),
						'v2'      => esc_html__( 'Style 2', 'interium' ),
						'v3'      => esc_html__( 'Style 3', 'interium' ),
						'v4'      => esc_html__( 'Style 4', 'interium' ),
						'v5'      => esc_html__( 'Style 5', 'interium' ),
						'v6'      => esc_html__( 'Style 6', 'interium' ),
						'v7'      => esc_html__( 'Style 7', 'interium' ),
						'v8'      => esc_html__( 'Style 8', 'interium' ),
						'v9'      => esc_html__( 'Style 9', 'interium' ),
						'v10'     => esc_html__( 'Style 10', 'interium' ),
					),
					'type' => 'control',
				),
			);
