...
if ( ! class_exists( 'Interium_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Interium_Woo_Breadcrumbs_Module class
	 */
	class Interium_Woo_Breadcrumbs_Module extends Interium_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Interium_WC_Breadcrumbs( $args );
