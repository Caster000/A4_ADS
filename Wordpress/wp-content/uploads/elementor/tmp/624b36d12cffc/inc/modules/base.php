...
if ( ! class_exists( 'Interium_Module_Base' ) ) {

	/**
	 * Define Interium_Module_Base class
	 */
	abstract class Interium_Module_Base {
		...
		public function load_child_modules( $childs = array() ) {
			...
			foreach ( $childs as $child => $childs_of_child ) {
				interium_theme()->load_module( $child, $childs_of_child );
			}
