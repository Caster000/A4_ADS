...
function interium_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'interium-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'interium_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'interium' ),
			) );
 ...
 * @return void
 */
function interium_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'interium-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'interium' ),
		) );
 ...
 * @return string
 */
function interium_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'interium-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'interium_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'interium' ),
	), $context, $type );
 ...
 * @return void
 */
function interium_set_nav_menu( $args ) {
