...
if ( ! class_exists( 'Interium_Widget_Area' ) ) {

	class Interium_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'interium-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'interium-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'interium-theme/widget_area/classes', $classes, $area_id );
	...
	function interium_widget_area() {
		return Interium_Widget_Area::get_instance();
	}

	interium_widget_area();
}
