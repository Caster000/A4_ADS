...
if ( ! class_exists( 'Interium_Woo_Page_Title_Module' ) ) {

	/**
	 * Define Interium_Woo_Page_Title_Module class
	 */
	class Interium_Woo_Page_Title_Module extends Interium_Module_Base {
